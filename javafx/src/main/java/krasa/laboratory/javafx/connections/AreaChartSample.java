...
public class AreaChartSample extends Application {
    ...
    private void createRestSerie(LineChart<Number, Number> chart, ObjectInstance endpoint, String hi1) {
        final HelloEndpointChartSeries numberSerie1 = new HelloEndpointChartSeries(endpoint,
                springJmxClientBean);
    ...
    public void reconnectJmx() throws Exception {
        ...
        for (NumberSeries numberSery : numberSeries) {
            if (numberSery instanceof HelloEndpointChartSeries) {
                ((HelloEndpointChartSeries) numberSery).setSpringJmxClientBean(springJmxClientBean);
            }
        }
